...
// L:100; H:560
// TODO update PEN1 min and max a little more
// for pen1 ppmmax is for positive angle
int PPMMIN[]  {120, 198, 213, 206}; //{206, 213, 198, 108}; //PLEASE ENTER: The lower motor PPM limit (Servo Min) as noted in your EDMO-setup
int PPMMAX[]  {520, 386, 402, 393}; //{393, 402, 386, 550}; //PLEASE ENTER: The upper motor PPM limit (Servo Max) as noted in your EDMO-setup

int ANGMIN[] {-90, -45, -45, -45}; //Minimum motor range in degs
int ANGMAX[] {90, 45, 45, 45}; //Maximum motor range in degs

int POTIMIN[]  {545, 584, 546, 560}; //{0, 0, 560, 585}; //PLEASE ENTER: The lower potentiometer limit (Poti Low)as noted in your EDMO-setup
int POTIMAX[]  {257, 291, 268, 275}; //{0, 0, 303, 351}; //PLEASE ENTER: The lupper potentiometer limit (Poti High)as noted in your EDMO-setup
...
void readInput(){
  // input = 'ID,M-N,angle,delay,M-N,...'
  // always use same ID, otherwise strange things happen
  // ID = 'S' stops the motor
  
  //Check for data on the serial input and read input data if available
  if (Serial.available()){    
